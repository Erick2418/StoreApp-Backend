...
var loginUsuario = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, emailExist, validPassword, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, jwt_1.generarJWT)(emailExist.id + "", emailExist.nombre)];
            case 3:
                token = _b.sent();
